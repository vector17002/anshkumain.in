...
export const Hero = () => {
  return (
    <div className='flex flex-col md:flex-row justify-between items-start md:space-x-14 w-full mb-10'>
        ...
        <div className="items-center flex-wrap text-zinc-800 dark:text-zinc-400 mb-5 text-base font-medium">
        System Engineer at <span className="font-extrabold bg-slate-200 p-1 rounded-sm dark:text-black px-2">TCS</span>
        </div>
